...
# ---------------------- Display image without crop/stretch

def prepare_display_image(image):

    height, width = image.shape[:2]

    # Maximum area in which the image can be displayed.

    max_width = 1200
    max_height = 650

    # Find how much the image needs to be reduced.
    ...
    # Do not enlarge a small image.

    if scale > 1:
        scale = 1

    # Calculate new size using the SAME scale
    # for width and height.
    # This keeps the original shape.
    ...
    # Find the position needed to put
    # the image exactly in the center.
    ...
    # Put the complete image in the center.
    # Empty space will remain around it.
...
# ---------------- Show ----------------
 ...
 # Empty space is left around it.
 # No crop and no stretch.
